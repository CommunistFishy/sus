...
// Load Cookie Clicker mods
LoadScript('https://klattmose.github.io/CookieClicker/CCSE.js', function(){
    console.log('CCSE mod loaded successfully.');
}, function(){
    console.error('Failed to load CCSE mod.');
});

LoadScript('https://klattmose.github.io/CookieClicker/Horticookie.js', function(){
    console.log('Horticookie mod loaded successfully.');
}, function(){
    console.error('Failed to load Horticookie mod.');
});

LoadScript('https://rainslide.neocities.org/cookieclicker/GoldenCookieClicker.js', function(){
    console.log('Golden Cookie Clicker mod loaded successfully.');
}, function(){
    console.error('Failed to load Golden Cookie Clicker mod.');
});
